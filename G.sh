...
export FILE2=/tmp/bcp.2
cat /dev/null > ${FILE1}

# correct FILE2
export FILE2a="2018bcp/cmc"
...
----- -----
2018/01/15/cmc.2018-01-15-21-00.json
2018/01/15/cmc.2018-01-15-23-15.json
root@bbb:/opt/coins/coinmarketcap# ls ../mph/2018bcp | tail
mph.2018-01-16-08-38.bcp
